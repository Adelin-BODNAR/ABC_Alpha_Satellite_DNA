...
*/
Output_data amplification_simulation (int max_size, double amplification_rate, double alpha_amplification_size, double beta_amplification_size, int min_amplification_size, int max_amplification_size, double alpha_HOR_order, double beta_HOR_order, int min_HOR_order, int max_HOR_order, int verbose ) {
    ...
    while(outputs.monomers_dataset.size() < max_size) {
        ...
        if (verbose > 0){
            std::cout << std::endl << "Amplification size : " << amplification_size << "\t"<< "HOR order: " << HOR_order << "\t"<< "Index head monomer to amplify: " << index_head_monomers_to_amplify << std::endl << std::endl;
