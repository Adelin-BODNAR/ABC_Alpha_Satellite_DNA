...
Output_data amplification_simulation (int max_size, double amplification_rate, double alpha_amplification_size, double beta_amplification_size, int min_amplification_size, int max_amplification_size, double alpha_HOR_order, double beta_HOR_order, int min_HOR_order, int max_HOR_order, bpp::Sequence ancestor_monomer, std::shared_ptr<const bpp::Alphabet> alpha, double substitution_rate, int substitution_model_choice, int verbose ) {
    ...
    std::map<char,std::map<double,double>> substitution_model_probs ;
    ...
    switch (substitution_model_choice){
        ...
        case (0):
            ...
            substitution_model_probs =  {   {'A', {         {1,1/3},    {2,1/3},    {3,1/3} }}, 
                                            {'C', {{0,1/3},             {2,1/3},    {3,1/3} }}, 
                                            {'G', {{0,1/3}, {1,1/3},                {3,1/3} }}, 
                                            {'T', {{0,1/3}, {1,1/3},    {2,1/3}             }}
                                        };
    ...
    //std::map<char,bpp::SimpleDiscreteDistribution> substitution_model_distribs = {   {'A', bpp::SimpleDiscreteDistribution(substitution_model_probs['A']) }, 
    //                                                {'C', bpp::SimpleDiscreteDistribution(substitution_model_probs['C']) }, 
    //                                                {'G', bpp::SimpleDiscreteDistribution(substitution_model_probs['G']) }, 
    //                                                {'T', bpp::SimpleDiscreteDistribution(substitution_model_probs['T']) }
    //                                            };
